...
export class ProductService {
  ...
  private static products: Product[] = [
    ...
    },
    {
      ...
      imageUrl: 'https://www.sony.cl/electronics/audifonos-banda-cabeza/wh-xb910n',
      status: 'Reportado',
      location: 'Sala de Juegos',
      dateReported: new Date(),
    },
    {
      ...
      imageUrl: 'https://www.samsung.com/es/tvs/full-hd-tv/n5300-40-inch-full-hd-smart-tv-ue40n5300akxxc/',
      status: 'Reportado',
      location: 'Sala de Juegos',
      dateReported: new Date(),
    }
